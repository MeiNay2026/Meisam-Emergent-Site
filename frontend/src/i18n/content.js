...
const en = {
  ...
  about: {
    ...
    paragraphs: [
      "I did not become a surgeon to perform as many operations as possible. I became one to give people clear answers in moments that feel frightening and uncertain.",
      "My path began in Sweden, where the Karolinska tradition taught me that precision and humility matter more than ego. I sharpened my skills further in the United States within Level I trauma centres, and through military and disaster medicine, where calm, fast, sound judgement is everything.",
      "Today, at American Hospital Dubai, I bring that whole journey to every patient — Scandinavian rigour, American intensity and a deeply personal belief that the best surgery is often the one you help a patient avoid.",
    ],
    philosophyTitle: "My philosophy",
    philosophy:
      "\u201CGive patients clarity, offer surgery only when it truly helps, and treat every person the way I would want my own family to be treated.\u201D",
    stats: [
      { value: "15+", label: "Years in surgery" },
      { value: "3", label: "Countries of practice" },
      { value: "1000s", label: "Patients guided" },
    ],
  },
  journey: {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Which languages do you speak?", a: "Consultations are available in English, Swedish and Arabic, so you can discuss your care in the language you're most comfortable in." },
    ],
  },
  insurance: {
...
const ar = {
  ...
  about: {
    ...
    paragraphs: [
      "لم أصبح جرّاحًا لأُجري أكبر عدد من العمليات، بل لأمنح الناس إجابات واضحة في لحظات مخيفة وغير مؤكدة.",
      "بدأت رحلتي في السويد، حيث علّمني تقليد كارولينسكا أن الدقة والتواضع أهم من الأنا. ثم صقلت مهاراتي في الولايات المتحدة داخل مراكز صدمات المستوى الأول، وعبر الطب العسكري والكوارث.",
      "اليوم، في المستشفى الأمريكي دبي، أحمل هذه الرحلة كلها لكل مريض — دقة اسكندنافية وحدّة أمريكية وإيمان عميق بأن أفضل جراحة هي غالبًا تلك التي تساعد المريض على تجنّبها.",
    ],
    philosophyTitle: "فلسفتي",
    philosophy:
      "«امنح المرضى الوضوح، واقترح الجراحة فقط حين تفيد حقًا، وعامل كل شخص كما أتمنى أن تُعامل عائلتي.»",
    stats: [
      { value: "+15", label: "سنة في الجراحة" },
      { value: "3", label: "دول ممارسة" },
      { value: "آلاف", label: "مريض تمت مساعدته" },
    ],
  },
  journey: {
    overline: "رحلتك معي",
  ...
  faq: {
    ...
    items: [
      ...
      { q: "ما اللغات التي تتحدثها؟", a: "الاستشارات متاحة بالإنجليزية والسويدية والعربية لتناقش رعايتك باللغة الأكثر راحة لك." },
    ],
  },
  insurance: {
...
const sv = {
  ...
  about: {
    ...
    paragraphs: [
      "Jag blev inte kirurg för att utföra så många operationer som möjligt. Jag blev det för att ge människor tydliga svar i stunder som känns skrämmande och osäkra.",
      "Min väg började i Sverige, där Karolinska-traditionen lärde mig att precision och ödmjukhet betyder mer än ego. Jag vässade sedan mina färdigheter i USA på nivå I-traumacenter och inom militär- och katastrofmedicin.",
      "Idag, på American Hospital Dubai, tar jag med hela den resan till varje patient — skandinavisk noggrannhet, amerikansk intensitet och en djup övertygelse om att den bästa operationen ofta är den man hjälper patienten att undvika.",
    ],
    philosophyTitle: "Min filosofi",
    philosophy:
      "”Ge patienter tydlighet, erbjud kirurgi bara när den verkligen hjälper, och behandla varje person som jag skulle vilja att min egen familj behandlades.”",
    stats: [
      { value: "15+", label: "År inom kirurgi" },
      { value: "3", label: "Länder av verksamhet" },
      { value: "1000-tals", label: "Patienter vägledda" },
    ],
  },
  journey: {
  ...
  faq: {
    ...
    items: [
      ...
      { q: "Vilka språk talar du?", a: "Konsultationer finns på engelska, svenska och arabiska, så du kan diskutera din vård på det språk du är mest bekväm med." },
    ],
  },
  insurance: {
